...
function $s_Lexamples_webapp_ExampleApp$__main__Lexamples_webapp_ExampleApp$__V($this) {
  $i_react$002ddom.render($i_react.createElement("p", {}, "Hello World from React.js!"), $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("app"));
  $m_Lorg_scalajs_dom_package$().console__Lorg_scalajs_dom_raw_Console().log("Hello world!")
}
/** @constructor */
function $c_Lexamples_webapp_ExampleApp$() {
  $g.Object.call(this)
}
/** @constructor */
function $h_Lexamples_webapp_ExampleApp$() {
  /*<skip>*/
}
$h_Lexamples_webapp_ExampleApp$.prototype = $g.Object.prototype;
$c_Lexamples_webapp_ExampleApp$.prototype = new $h_Lexamples_webapp_ExampleApp$();
$c_Lexamples_webapp_ExampleApp$.prototype.constructor = $c_Lexamples_webapp_ExampleApp$;
$c_Lexamples_webapp_ExampleApp$.prototype.main = (function() {
  $s_Lexamples_webapp_ExampleApp$__main__Lexamples_webapp_ExampleApp$__V(this)
});
var $n_Lexamples_webapp_ExampleApp$ = (void 0);
function $m_Lexamples_webapp_ExampleApp$() {
  if ((!$n_Lexamples_webapp_ExampleApp$)) {
    $n_Lexamples_webapp_ExampleApp$ = new $c_Lexamples_webapp_ExampleApp$()
  };
  return $n_Lexamples_webapp_ExampleApp$
}
$e.ExampleApp = $m_Lexamples_webapp_ExampleApp$;
...
//# sourceMappingURL=scala-js-examples-fastopt.js.map
